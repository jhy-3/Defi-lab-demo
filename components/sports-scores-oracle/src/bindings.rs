...
pub unsafe fn _export_run_cabi<T: Guest>(arg0: *mut u8) -> *mut u8 {
    ...
    let l27 = i32::from(*arg0.add(12 * ::core::mem::size_of::<*const u8>()).cast::<u8>());
    use wavs::worker::layer_types::TriggerData as V67;
    let v67 = match l27 {
        0 => {
            let e67 = {
                let l28 = *arg0.add(8 + 12 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l29 = *arg0.add(8 + 13 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len30 = l29;
                let l31 = *arg0.add(8 + 14 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l32 = *arg0.add(8 + 15 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len33 = l32;
                let bytes33 = _rt::Vec::from_raw_parts(l31.cast(), len33, len33);
                let l34 = *arg0.add(8 + 16 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l35 = *arg0.add(8 + 17 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let base39 = l34;
                let len39 = l35;
                ...
                let l40 = *arg0.add(8 + 18 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l41 = *arg0.add(8 + 19 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len42 = l41;
                let l43 = *arg0.add(8 + 20 * ::core::mem::size_of::<*const u8>()).cast::<i64>();
        ...
        1 => {
            let e67 = {
                let l44 = *arg0.add(8 + 12 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l45 = *arg0.add(8 + 13 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len46 = l45;
                let bytes46 = _rt::Vec::from_raw_parts(l44.cast(), len46, len46);
                let l47 = *arg0.add(8 + 14 * ::core::mem::size_of::<*const u8>()).cast::<i32>();
                let l48 = *arg0.add(8 + 15 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l49 = *arg0.add(8 + 16 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len50 = l49;
                let bytes50 = _rt::Vec::from_raw_parts(l48.cast(), len50, len50);
                let l51 = *arg0.add(8 + 17 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l52 = *arg0.add(8 + 18 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len53 = l52;
                let bytes53 = _rt::Vec::from_raw_parts(l51.cast(), len53, len53);
                let l54 = *arg0.add(8 + 19 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l55 = *arg0.add(8 + 20 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let base62 = l54;
                let len62 = l55;
                ...
                for i in 0..len62 {
                    ...
                    let e62 = {
                        ...
                        let l57 = *base.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
                        let len58 = l57;
                ...
                let l63 = *arg0.add(16 + 20 * ::core::mem::size_of::<*const u8>()).cast::<i64>();
        ...
        n => {
            debug_assert_eq!(n, 2, "invalid enum discriminant");
            let e67 = {
                let l64 = *arg0.add(8 + 12 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l65 = *arg0.add(8 + 13 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len66 = l65;
    ...
    match result68 {
        Ok(e) => {
            *ptr69.add(0).cast::<u8>() = (0i32) as u8;
            match e {
                Some(e) => {
                    *ptr69.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (1i32) as u8;
                    let vec70 = (e).into_boxed_slice();
                    let ptr70 = vec70.as_ptr().cast::<u8>();
                    let len70 = vec70.len();
                    ::core::mem::forget(vec70);
                    *ptr69.add(3 * ::core::mem::size_of::<*const u8>()).cast::<usize>() = len70;
                    *ptr69.add(2 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>() =
                        ptr70.cast_mut();
                }
                None => {
                    *ptr69.add(::core::mem::size_of::<*const u8>()).cast::<u8>() = (0i32) as u8;
                }
            };
        }
        Err(e) => {
            ...
            *ptr69.add(::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr71.cast_mut();
        }
    };
    ptr69
}
...
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.41.0:wavs:worker@0.3.0:layer-trigger-world:encoded world")]
#[doc(hidden)]
